        ...
        if self.bootstrap_ci:
            for name in list(scores.keys()):
                if name == "MammoRGScore":
                    ...
                    scores["relation_f1"] = {'median': metrics['Relations_metrics']["f1"],'ci_l': metrics['Relations_metrics']["f1_ci"][0], 'ci_h': metrics['Relations_metrics']["f1_ci"][1]}
            ...
            for name in list(scores.keys()):
                if name == "MammoRGScore":
                    ...
                    scores["relation_f1"] = metrics['Relations_metrics']["f1"]
