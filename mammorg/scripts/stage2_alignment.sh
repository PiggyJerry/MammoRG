...
PRETRAIN="${base_dir}/${model_name}/checkpoints/stage1/non_lora_trainables.bin"
...
deepspeed --master_port 29511 --include localhost:1 ${base_dir}/${model_name}/llava/train/train_mem.py \
